  ...
  return (
    <Wrapper>
      <Flex flexDirection={['column', 'column', 'row']} alignItems="center">
        ...
        <LinkExternal
          id="ercBridge"
          href="https://www.binance.org/en/bridge?utm_source=HairToken"
          ml={[0, 0, '40px']}
          mt={['20px', '20px', 0]}
          mb={['8px', '8px', 0]}
        >
          {t('  Click here to convert ERC-20 to BEP-20')}
        </LinkExternal>
      </Flex>
      <Flex
        flexGrow={1}
      ...
      >
        ...
        <Image src="/images/help.svg" alt="Get some help" width={320} height={216} />
      </Flex>
    </Wrapper>
  )
}
