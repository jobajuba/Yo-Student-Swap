...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('0.02% of the total HAIR token supply give away. The more people follow us the more we give away. ', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Follow us on Facebook, Twitter, Medium and Instagram for a change to win free HAIR tokens')}
        </Text>
      </Flex>
