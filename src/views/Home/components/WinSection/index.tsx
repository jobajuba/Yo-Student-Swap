    ...
    <>
      ...
      <TransparentFrame isDark={theme.isDark}>
        <Flex flexDirection="column" alignItems="center" justifyContent="center">
          <ColoredWordHeading textAlign="center" text={t('Buy HAIR on YoSwap for a chance to win big!')} />
          <Text color="textSubtle">{t('The HAIR token is our official currency, allowing investors increase their worth. HAIR is constantly growing its reach due to its international renown and real utility. YoSwap, our proprietary DEX, is the first to feature and reward HAIR.')}</Text>
