...
const Stats = () => {
  ...
  return (
    <Flex justifyContent="center" alignItems="center" flexDirection="column">
      ...
      <img src="./images/sun.svg" alt="Kiwi standing on oval"/>
      <Heading textAlign="center" scale="xl">
        {t('Connecting millions.')}
      </Heading>
      <Heading textAlign="center" scale="xl" mb="32px">
        {t('And kicking down the door to the billions.')}
      </Heading>
      <Text textAlign="center" color="textSubtle">
        {t('YoSway has one of the most users of any decentralized platform, ever.')}
      </Text>
      <Flex flexWrap="wrap">
      ...
      <Text textAlign="center" color="textSubtle" bold mb="32px">
        {t('Will you join our growing ecosystem?')}
      </Text>
